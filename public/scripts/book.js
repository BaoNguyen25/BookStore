...
let close_buy_section = document.getElementById("close-buy-btn");
...
let submit_buy_btn = document.getElementById("submit-buy-btn");
...
buy_btn.addEventListener('click', () => {
    let buy_section = document.getElementById("buy-book");
    buy_section.style.display = 'block';
})

close_buy_section.addEventListener('click', (event) =>{
    event.preventDefault();
    let buy_section = document.getElementById("buy-book");
    buy_section.style.display = "none";
})
